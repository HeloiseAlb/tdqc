...
def test_deep_q_learning_state_provider_solve_trans_ising():
    ...
    from tdqc.numerics.state_provider.parameters_state_provider_trans_ising import parameters, parameters_replay_memory
    solver = DQLWithReplayMemory()
    solver.load_settings(settings=parameters)
    solver.load_seetings_replay_memory(**parameters_replay_memory)
    solver.solve()
...
def test_deep_q_learning_state_provider_solve_anderson_model_square():
    from tdqc.solver.deep_q_learning import DQLWithReplayMemory
    from tdqc.numerics.state_provider.parameters_state_provider_anderson_model_square_lattice_tridiago import parameters, parameters_replay_memory
    solver = DQLWithReplayMemory()
    solver.load_settings(settings=parameters)
    solver.load_seetings_replay_memory(**parameters_replay_memory)
    solver.solve()
